export const getT = () => ({
	i: {
		...
		buttons: {
			...
			addPlacePointToMeasure: 'Add the place point to the ruler',
			addPlacePointToRoute: 'Add the place point to the current route',
			back: 'Back',
			cancel: 'Cancel',
			center: 'Map center',
			checkAll: 'Check all',
		...
		hints: {
			...
			exchange: 'Import / Export places in GPX or JSON format',
			exit: 'Log out',
		...
		maps: {
			...
			chooseTilesZip: 'Choose the ZIP archive with tiles',
			clearTileDatabase: 'Reset downloaded tiles',
			mapImport: 'Import an offline map',
			maps: 'Maps',
			osm: 'Primary map',
			railroads: 'Railroads',
			satellite: 'Satellite',
			tileDatabaseCleared: 'The tile database has been cleared.',
			tilesLoaded: 'Tiles loaded successfully',
			topography: 'Topography',
			tourists: 'Topography for tourists',
			transport: 'Mass transit',
			unpackingTiles: 'Unpacking tiles',
		},
	},
	m: {
		paged: {
...
Your data won’t be saved to your account and will be cleared when you log out.`,
		...
		errors: {
			...
			maps: {
				failedToClearTileDatabase: 'Failed to clear tile database.',
				failedToImportZip: 'Failed to import ZIP archive.',
			},
			other: {
				other: 'unknown error',
