export const t = {
	i: {
		...
		text: {
			emailToSendPassword: 'Enter the e-mail address you provided during registration. Your login and new password will be sent to it.',
	...
	m: {
		paged: {
			...
			loginTaken: 'This login is taken, please choose another one.',
			...
			forgotLetterSent: 'An e-mail with your login and new password has been sent to the e-mail address specified by you. When chewing, you can change them in your personal account after authorization.',
