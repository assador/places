...
export const accountSaveRoutine = (account, voc) => {
    if (account.accountNewPassword == undefined)
        account.accountNewPassword = '';
...
export const accountDeletionRoutine = (userId, leavePlaces, leaveImages) => {
    axios.post('/backend/delete_account.php', { userId: userId, leavePlaces: leavePlaces, leaveImages: leaveImages });
};
