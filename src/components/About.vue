<template>
	...
	>
		...
		<ul>
			...
			<li><a href="#__RefHeading___Toc1348_2010873736">Незевисисые точки</a></li>
			</ul>
		<h2><a id="__RefHeading___Toc412_2631625936" />Введение</h2>
		<p>ГеоОрганайзер «Места» — это онлайн-сервис, позволяющий создавать свои коллекции мест на карте с подробной информацией о них. Собирать их вместе, сортировать по папкам, просматривать, редактировать и обмениваться с другими. Экспортировать свои (для навигаторов, например), импортировать места других людей.</p>
		...
		<p>Проект свободный, постоянно развивается. Любой желающий может принять участие и делать пул-реквесты или форкать и развивать самостоятельно, создавая свои собственные сервисы. Написан на Vue.js. Сейчас проект находится здесь — <a href="https://github.com/assador/places" target="_blank">https://github.com/assador/places</a></p>
		...
		<ul>
			...
			<li>
				<p>«<strong>Измерить</strong>» (Alt + Shift + m). Переходит в режим вычисления расстояния между выделенными местами. После нажатия на кнопку нужно последовательно выбирать места правой кнопкой мыши либо в меню, либо на карте. При этом вычисляется расстояние между этими местами, в той же последовательности, в которой они выбраны, расстояние пути по всем этим местам. Эту последовательность можно менять, перетаскивая эти места в списке. Также, каждое место можно заменить на другое, кликнув на кнопку со стрелкой напротив этого места в списке и выбрав другое (правой кнопкой мыши, что на карте, что в дереве мест). Можно также удалить каждое место из списка, кликнув на кнопку с крестиком, либо кликнув правой кнопкой мыши на это выбранное место в меню или на карте.</p>
			</li>
		</ul>
		...
		<p>Это, собственно, карта. Сейчас она реализована двумя сервисами: <a href="https://www.openstreetmap.org/" target="_blank">OpenStreetMap</a> и <a href="https://maps.yandex.ru/" target="_blank">Яндекс.Карты</a>. Это обычные карты этих провайдеров, настроенные для работы в сервисе.</p>
		...
		<h2><a id="__RefHeading___Toc1348_2010873736" />Незевисисые точки</h2>
		<p>Помимо, собственно, «мест» есть возможность добавлять на карту временные, независимые от самих мест, «служебные» точки. Это не места с названиями, описаниями и пр. У них, по большому счёту, есть только координаты. Вообще говоря, технически, к самим «местам» привязаны такие же точки; они являются одним из свойств мест, наравне с названиями, описаниями и пр.</p>
		<p>Но в отличие от привязанных к местам точек эти независимые точки не сохраняются в базу данных и нужны просто для того, чтобы, например, измерить расстояние, не создавая при этом полноценные места. Их легко добавлять, просто кликая по карте в нужных местах првой кнопкой мыши.</p>
	</div>
</template>
