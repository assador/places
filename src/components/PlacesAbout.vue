...
>https://github.com/assador/places</a></p>
		...
		<ul>
			...
			<li>
				<p>«<strong>Измерить</strong>» (Alt + Shift + m). Переходит в режим вычисления расстояния между выделенными местами. После нажатия на кнопку нужно последовательно выбирать места либо в меню, либо на карте. При этом вычисляется расстояние между этими местами, в той же последовательности, в которой они выбраны, расстояние пути по всем этим местам. Эту последовательность можно менять, перетаскивая эти места в списке. Также, каждое место можно заменить на другое, кликнув на кнопку со стрелкой напротив этого места в списке и выбрав другое. Можно также удалить каждое место из списка, кликнув на кнопку с крестиком, либо кликнув на это выбранное место в меню или на карте.</p>
			</li>
		</ul>
...
>Яндекс.Карты</a>. Это обычные карты этих провайдеров, настроенные для работы в сервисе.</p>
		<p>При клике на метку места оно становится активным, текущим, показывается его описание, как и при клике на место в меню слева. Метки можно перетаскивать (свои метки; «общие», не ваши — нет, о чём ниже). При этом, естественно, меняется информация о широте / долготе / высоте этого места.</p>
