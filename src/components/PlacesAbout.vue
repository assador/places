...
>https://github.com/assador/places</a></p>
		...
		<ul>
			...
			<li>
				...
				<p>В режиме измерения расстояния есть возможность добавлять на карту временные, «служебные» точки. Это не места с названиями, описаниями и пр. У них, по большому счёту, есть только координаты. Они не сохраняются в базу данных и нужны просто для того, чтобы, например, измерить расстояние, не создавая при этом полноценные места. Их легко добавлять, просто кликая по карте в нужных местах првой кнопкой мыши.</p>
			</li>
		</ul>
