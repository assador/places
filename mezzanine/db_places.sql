...
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trg_points_au` AFTER UPDATE ON `points` FOR EACH ROW BEGIN
    ...
    UPDATE users u
    JOIN routes r
    JOIN pointroute pr ON pr.routeid = r.id
    SET u.lastupdates = FLOOR(UNIX_TIMESTAMP(NOW(3)) * 1000)
...
CREATE TABLE `sessions` (
  ...
  `expiresat` bigint(20) unsigned NOT NULL,
...
--
-- Table structure for table `settings_users_voc`
--

DROP TABLE IF EXISTS `settings_users_voc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
-- Dump completed on 2026-09-17  2:07:53
